...
<body>
    ...
    <form class="notice_write" name="notice_form" action="insert.php" method="post" onsubmit="return notice_check()">
        <fieldset>
            <legend>Notice</legend>
            <p>
                <input class="n_title" type="text" name="n_title" id="n_title" placeholder="제목 입력">
            </p>
            <p>
                <textarea class="n_content" cols="60" rows="10" name="n_content" id="n_content"></textarea>
            </p>
            <p>
